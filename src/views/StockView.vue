<template>
  ...
  <ListaCompras
  :produtos="produtos"
  :mostrar="mostrarListaCompras"
  @fechar="mostrarListaCompras = false"
/>
</div>
        </div>
        ...
        <div v-if="produtosFiltrados.length" class="products-grid">
          ...
          >
            ...
            <div class="stock-info">
              ...
              <span
                class="status-badge"
                :class="getStatus(produto).classe"
              >
            ...
            <div class="stock-bar">
              ...
              <div
                ...
                :class="getStatus(produto).classe"
                :style="{ width: calcularPorcentagem(produto) + '%' }"
              ></div>
            ...
            <div class="product-footer">
              ...
              <span>
                Mínimo: {{ produto.minimo }} {{ produto.unidade }}
              </span>
...
function calcularPorcentagem(produto) {
  if (produto.quantidade === 0) return 0
...
function salvarProduto() {
  ...
  if (modoEdicao.value) {
    const index = produtos.value.findIndex(
      produto => produto.id === form.value.id
    )
    ...
    produtos.value.push({
      ...form.value,
      id: Date.now(),
      icone: getIcone(form.value.categoria)
    })
  }
